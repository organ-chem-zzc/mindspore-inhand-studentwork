...
public class MeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // 分享按钮
        View shareView = view.findViewById(R.id.rl_me_share);
        shareView.setOnClickListener(this);
        shareView.setVisibility(View.GONE);

        // 点赞按钮
        View thumbsupView = view.findViewById(R.id.rl_me_thumbsup);
        thumbsupView.setOnClickListener(this);
        thumbsupView.setVisibility(View.GONE);

        // 官方网站
        View officialView = view.findViewById(R.id.rl_me_official);
        officialView.setOnClickListener(this);
        officialView.setVisibility(View.GONE);

        // 官方代码
        View officialCodeView = view.findViewById(R.id.rl_me_official_code);
        officialCodeView.setOnClickListener(this);
        officialCodeView.setVisibility(View.GONE);

        // QA
        View qaView = view.findViewById(R.id.rl_me_qa);
        qaView.setOnClickListener(this);
        qaView.setVisibility(View.GONE);

        // 版本信息
        View versionView = view.findViewById(R.id.rl_me_version);
        versionView.setOnClickListener(this);
//        versionView.setVisibility(View.GONE);

        // 用户协议
        View protocolView = view.findViewById(R.id.me_user_protocol);
        protocolView.setOnClickListener(this);
        protocolView.setVisibility(View.GONE);

        // 二维码
        View qrCodeView = view.findViewById(R.id.rl_me_qr_code);
